function visualizeSIFT2(d, f, varargin)
% visualize SIFT feature like HOG ( negative values allowed )
% by Minsu Cho

fprintf('visualing SIFT...');
descScale = 2.0;
NBO = 8;
...
%vl_plotsiftdesc_mcho2(d, f, 'drawingtype', 'gradient', 'magnif', magnif, 'NBO', NBO, 'NBP', NBP) ;
vl_plotsiftdesc_mcho2(d, f, 'drawingtype', 'edge', 'magnif', magnif, 'NBO', NBO, 'NBP', NBP) ;
